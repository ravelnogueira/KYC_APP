import { Box, Button, FormLabel, Text, Image, Spinner, useDisclosure, Modal, ModalOverlay, ModalContent, ModalCloseButton, ModalBody } from '@chakra-ui/react'
import { useState } from 'react';
import { useForm } from 'react-hook-form';
import classes from "./ConsultaCpf.module.css";
import image from "../../asset/PortalTransparencia.png"
...
function ConsultaCliente() {
    ...
    async function onSubmit(register: FormCpf) {
        ...
        setSpinner(true)
        setLoading(true)
        fetch(`http://localhost:5000/buscartransparencia/${cpf}`)
            .then(res => res.json())
            .then(data => {
